...
class ExtractGapRegionStep {
    ...
    ImagePlus runII(ImagePlus Imp, double ncDia, int Tolerance, boolean GapRefine){
        ...
        LocThkIp.setThreshold(1.0,  ncDia * 2)
...
def runNucleusExtraction(PipelineContext ctx) {
    ...
    ImagePlus gapRegion = gapExtractor.runII(oriMask, nucDia, 3, ctx.getGapRefine())
...
def askUserInput() {
    ...
    openImg.addFileField("Input image (.tiff):", null)
    openImg.setInsets(5,5,0)
    openImg.addMessage("Estimated nuclear diameter:", openfont, darkRed)
    openImg.setInsets(5,-75,0)
    openImg.addNumericField("", 0, 2, 8, " pixel")
    ...
    openImg.setInsets(10,5,0)
    openImg.addMessage("Set image scale: ", openfont, darkRed)
